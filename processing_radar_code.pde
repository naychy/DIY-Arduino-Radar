...
void drawText() { 
  ...
  fill(98,245,31);
  textSize(25);
  text("10cm",width-width*0.4,height-height*0.0833);
  text("20cm",width-width*0.3,height-height*0.0833);
  text("30cm",width-width*0.21,height-height*0.0833);
  text("40cm",width-width*0.11,height-height*0.0833);
  textSize(40);
  text("Object: " + (iDistance > 40 ? "Out of Range" : "In Range"), 
